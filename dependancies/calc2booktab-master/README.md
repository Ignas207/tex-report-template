[calc2booktab](https://github.com/schober-ch/calc2booktab)
============
...
- In libreoffice copy to here: `~/.config/libreoffice/4/user/Scripts/python/`
- Add `\hline` for nice lines and `|c|`
